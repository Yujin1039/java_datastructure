...
class BinTreeTester {
	...
	*/
	...
	public static void main(String[] args) {
		...
		/*
		 * Comparator<? super Integer> c = new KeyComparator(); BinTree<Integer, Data>
		 * tree = new BinTree<Integer, Data>(c);
		 */
		
		//람다식으로 작성
//		Comparator<Integer> REVERSED_KEY = (o1, o2) -> {
//    		if (o1 > o2) return -1;
...
//		};
		...
		final KeyComparator REVERSED_KEY = new KeyComparator();
		BinTree<Integer, Data> tree = new BinTree<Integer, Data>(REVERSED_KEY);
